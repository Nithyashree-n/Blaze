...
public class contact {
	...
	public void beforeMethod() throws IOException {
		...
		FileInputStream locator = new FileInputStream(System.getProperty("user.dir")
				+ "//src//test//java//Blaze//blazeLocators.properties");
		Locators = new Properties();
		Locators.load(locator);
		FileInputStream data = new FileInputStream(
				System.getProperty("user.dir") + "//src//test//java//Blaze/blazeData.properties");
		Data = new Properties();
		Data.load(data);
	...
	@Test(priority = 3)
	public contact() throws InterruptedException {
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
